    ...
    foreach($lesContinents as $continent){
        echo "<tr class='d-flex'>";
            ...
            echo "<td class='col-md-2'>
                ...
                <a href='#modalSuppression' data-toggle='modal'data-suppression='index.php?uc=continents&action=delete&num=".$continent->getNum()."' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
            </td>";
        echo "</tr>";
